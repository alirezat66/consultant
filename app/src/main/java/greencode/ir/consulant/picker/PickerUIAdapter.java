package greencode.ir.consulant.picker;
...
import greencode.ir.consulant.utils.IranSanseTextView;
...
class PickerUIAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        IranSanseTextView textItem = ViewHolder.get(convertView, R.id.tv_item);

        String option = items.get(position);
        textItem.setText(Utility.convertToPersianDigits(option));
        ...
        textItem.setTypeface(Utility.getRegularTypeFace(mContext));
